...
Starting in the middle of the pandemic, we've created an effective new software delivery organization not just by applying best practices in engineering, but by creating effective interdisciplinary workflows across product, design, "designgineering", and QA that allow teams to move quickly, learn quickly, and still deliver with rigorous quality. With repeated success from practices such as agile story-mapping, design sprints, and engineer-led scrum, we have created a new culture of shipping. 
